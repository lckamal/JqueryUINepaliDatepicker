...
function makeArray() {
    for (i = 0; makeArray.arguments.length > i; i++)
        this[i + 1] = makeArray.arguments[i]
}
function englishNo2Nep(t) {
    t = "" + t
    for (var e = "", s = 0; t.length > s; s++)
        e += convertNos(t[s])
    return e
}
...
function count_bs_days(t, e) {
    ...
    for (u = n; h >= u; u++)
        b += arraySum(this.bs[u])
    for (u = 0; r > u; u++)
        b -= this.bs[n][u]
    for (b += this.bs[n][11], u = d-1; 12 > u; u++)
        b -= this.bs[h][u]
    return b -= i + 1, b += o-1
}
...
function add_bs_days(t, e) {
    ...
    for (r += e; r > this.bs[a][n-1];)
        r -= this.bs[a][n-1], n++, n > 12 && (n = 1, a++)
    return a + "-" + n + "-" + r
}
function bs2ad(t) {
...
function ad2bs(t) {
    ...
    t.fn.nepaliDatePicker = function() {
        ...
        }), t(".ndp-nepali-calendar, #ndp-nepali-box").hover(function() {
            mouse_is_inside=!0
        }, function() {
            mouse_is_inside=!1
        }), t("html").mouseup(function() {
